{-# LANGUAGE TypeFamilies ,ViewPatterns ,UndecidableInstances ,OverlappingInstances #-}
{-# LANGUAGE RecordWildCards ,RecursiveDo ,TupleSections ,ParallelListComp #-}
...
{-# LANGUAGE ForeignFunctionInterface ,UnliftedFFITypes ,ImplicitParams ,UnboxedTuples #-}
{-# LANGUAGE StandaloneDeriving ,DeriveFunctor ,DeriveFoldable ,DeriveTraversable ,DeriveGeneric #-}
{-# LANGUAGE FlexibleContexts ,ConstrainedClassMethods ,FunctionalDependencies ,MagicHash #-}
{-# LANGUAGE PolymorphicComponents ,ExistentialQuantification ,UnicodeSyntax ,PostfixOperators #-}
{-# LANGUAGE PatternGuards ,LiberalTypeSynonyms ,RankNTypes ,TypeOperators #-}
{-# LANGUAGE EmptyDataDecls ,KindSignatures ,BangPatterns #-}
