{-# LANGUAGE FlexibleInstances, MultiParamTypeClasses, UndecidableInstances, GeneralizedNewtypeDeriving, OverlappingInstances #-}
module Stats(
    -- mutable
    Stats,
    new,
...
instance Applicative StatM where
    StatM f s1 <*> StatM y s2 = StatM (f y) (s1 `mappend` s2)
